...
class FasterRCNNBase(nn.Module):
    ...
    def forward(self, images,attr_vectors, targets=None):
        """
        Arguments:
        ...
        detections, detector_losses = self.roi_heads(features, proposals, images,attr_vectors, targets)
