...
class CityscrapesDetection(data.Dataset):
    ...
    def __init__(self, root, dataset="train", transforms=None):
        ...
        if dataset == "train":
            ...
            with open("/data/wuwentao/VehicleDetection/cityscrapes4_indices.json", "w") as f:
                f.write(json_str)
    ...
    def __getitem__(self, index):
        ...
        path = '/data/wuwentao/data/cityscapes/leftImg8bit/' + path
...
if __name__ == '__main__':
    train = CityscrapesDetection("/data/wuwentao/data/cityscapes/leftImg8bit/", dataset="train")
    print(len(train))
    t = train[0]
